...
$(function(){
	...
	function get_table(date,ec_id)
	{
		list_table = $("#courier_table").DataTable({
			...
			"ajax": {
				url: base_url + "returns/get_table", // json datasource
				data : {
					date : date,
					ec_id : ec_id,
			...
			'columnDefs': [
				...
				},
				{
					...
					'className': '',
					'render': function (data, type, full, meta) {
						var view = "<a href='" + base_url + "order/item/rrs/" + data.item_id + "' class='font-weight-bold text-light'>" + data.tracking_no +"</a>";
						return view;
					}
				},
				{
