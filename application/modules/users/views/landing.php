            ...
            <div class="card bg-default shadow">
                <div class="card-header bg-default">
                    <div class="card-tools float-right">
                        <button class="btn btn-primary" id="new_create"> <i class="fa fa-fw fa-plus"></i> Add
                            User</button>
                    </div>
                </div>
        ...
        <div class="modal-content">
            <form class='form-horizontal' id="form-user">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-user"></i> <span class="title">Create
                            User</span> </h5>
                ...
                <div class="modal-body">
                    <div id="header_msg"><?= $modal_msg ?></div>
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            ...
                            <input type="number" class="form-control" id="contact" name="contact" min="1" max="11"
                    ...
                    <div class="form-group row">
                        <div class="col-12 mb-2">
                            ...
                            <input type="password" class="form-control" id="userPass" name="contact"
                                placeholder="Enter Password" required />
                        </div>
                        <div class="col-12">
                            <label>Re-Enter Password</label>
                            <input type="password" class="form-control" id="userPassCheck" name="contact"
                                placeholder="Re-Enter Password" required disabled />
                        </div>
    ...
    function check(upass1, upass2) {
        ...
        if (upass1 != upass2) {
            if (pass_num1 >= 8 || pass_num2 >= 8) {
                ...
                $("#pass_msg").html(
                    "<small><b>*Warning!</b> Password not match ,Password must be at least 8 characters</small>"
                );
            }
        } else {
            if (username) {
