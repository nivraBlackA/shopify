        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?=base_url('pickup')?>">
              <i class="fas fa-truck text-primary"></i> Pickup
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?=base_url('delivery')?>">
              <i class="fas fa-motorcycle text-success"></i> Delivery
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?=base_url('returns')?>">
              <i class="fas fa-undo text-danger"></i> Return
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?=base_url('courier')?>">
              <i class="fas fa-motorcycle text-dark"></i> Courier
            </a>
          </li>
          <li class="nav-item">
